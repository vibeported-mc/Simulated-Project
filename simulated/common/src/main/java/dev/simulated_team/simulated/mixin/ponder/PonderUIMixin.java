...
public class PonderUIMixin {
    ...
    private int customShadowFade(final int constant, final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final int i, final float partialTicks) {
    ...
    private void shadowTranslate(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final int i, final float partialTicks, final CallbackInfo ci, @Local final PoseStack ms) {
